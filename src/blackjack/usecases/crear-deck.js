...
export const createDeck = (typesOfCards, especialTypes) => {
  if (!typesOfCards || typesOfCards.length === 0)
    throw new Error('typesOfCards it is required as an array of strings!');
  if (!especialTypes || especialTypes.length === 0)
    throw new Error('especialTypes it is required as an array of strings!');
